...
for (ListaPacienteNew in Pacientes){
    //console.log(`Id Paciente: ${ListaPacienteNew.IdPaciente} Nombre: ${ListaPacienteNew.Nombre} Identificacion: ${ListaPacienteNew.Identificacion}`)
...
SignosVitales.forEach((RevicionSignoNew)=>{
        console.log(`ID Signo Vital: ${RevicionSignoNew.IdSignoVital} Descripción: ${RevicionSignoNew.Descripcion} Nivel Minimo: ${RevicionSignoNew.NivelMinimo}  Nivel Maximo: ${RevicionSignoNew.NivelMaximo}`) })
console.log("--------------------------------------------------");
...
for (RevicionNew of ControlesRealizados){
    console.log(`ID de Contro Realizado ${RevicionNew.IdControlRealizado} ID Paciente: ${RevicionNew.IdPaciente} ID Signo Vital: ${RevicionNew.IdSgnoVital} Dia: ${RevicionNew.Fecha.Dia} Mes: ${RevicionNew.Fecha.Mes} Año: ${RevicionNew.Fecha.Año} hora: ${RevicionNew.Hora} Valor: ${RevicionNew.Valor}`)
}
console.log("--------------------------------------------------");
